...
function mantenimentoMeql() {
    ...
    const SodioDaPerdereRecuperare = (140 - Naig) * AcquaPerc * WW;
    const CalcoloAggiuntivo = (140 - Naig) * AcquaPerc * WW;
    ...
    const SommaDiexOreMl = (PerditeMl / Correzionedie) + PerditeprevedibiliMl + mantenimentoMl - soluzioneMl - liquidiAggiuntiMl;
    const SommaDiexOreMeq = ((PerditeMeq + CalcoloAggiuntivo) / Correzionedie) + PerditeprevedibiliMeq + mantenimentoMeq() - soluzioneMeq - liquidiAggiuntiNa;
